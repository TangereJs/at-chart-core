...
},{"../core/core.defaults":20,"../core/core.scale":27,"../core/core.scaleService":28,"../helpers/index":40,"moment":65}],54:[function(require,module,exports){
/* MIT license */
...
},{"color-name":64}],55:[function(require,module,exports){
/* MIT license */
...
},{"chartjs-color-string":54,"color-convert":63}],56:[function(require,module,exports){
'use strict';
...
},{"./colorschemes.brewer":56,"./colorschemes.office":57,"./colorschemes.tableau":58}],60:[function(require,module,exports){
'use strict';
...
},{"./colorschemes/index":59,"./plugins/plugin.colorschemes":61}],61:[function(require,module,exports){
'use strict';
...
},{"../colorschemes/index":59}],62:[function(require,module,exports){
/* MIT license */
...
function createChart(canvas, definition) {
  if (definition.palette) {
    definition.configuration.options.plugins = {
      colorschemes: {
  ...
  if (definition.template) {
    ...
    if (template) {
      definition.dimensions = Object.assign({}, template.dimensions, definition.dimensions);

      if (!definition.configuration.type) {
        definition.configuration.type = template.configuration.type;
      }

      definition.configuration.options = Object.assign(
        {}, template.configuration.options, definition.configuration.options
      );
    }
  }
...
},{"./templates/charts":67,"chart.js":1,"chartjs-node-plugin-colorschemes":60}],67:[function(require,module,exports){
module.exports={
	"bar": {
		"dimensions": {
			"width": "600",
